...
const TenantsListPage = lazy(() => import('./TenantsListPage.jsx').then(m => ({ default: m.TenantsListPage })))
const TenantFormPage = lazy(() => import('./TenantFormPage.jsx').then(m => ({ default: m.TenantFormPage })))
const EmpresaDetallePage = lazy(() => import('./EmpresaDetallePage.jsx').then(m => ({ default: m.EmpresaDetallePage })))
