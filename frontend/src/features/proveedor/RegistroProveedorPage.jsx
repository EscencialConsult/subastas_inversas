...
export function RegistroProveedorPage() {
  ...
  async function manejarSubmit(datos) {
    ...
    try {
      ...
      setConfirmacion(respuesta.message || 'Tus datos fueron enviados a verificacion.')
      reset(VACIO)
    } catch (err) {
  ...
  return (
    <div className="public-page">
      ...
      <section className="public-form">
        <form className="public-form__card" onSubmit={handleSubmit(manejarSubmit)} noValidate>
          <div>
          ...
          <Button className="mt-16" fullWidth type="submit" loading={enviando}>
